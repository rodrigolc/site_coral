...
from .serializers import PostSerializer,LivroSerializer,TextoSerializer,IlustracaoSerializer,PoemaSerializer,ColecaoSerializer                     # add this
from .models import Post,Livro,Texto,Ilustracao,Poema,Colecao                     # add this
